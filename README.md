...
| 文件 | 说明 |
| --- | --- |
| `collectorlite_<版本>_x64-setup.exe` | **NSIS 安装器**（推荐）：双击安装，桌面 / 开始菜单生成图标 |
| `collectorlite_<版本>_x64.zip` | **免安装便携版**：解压到任意文件夹，双击 `collectorlite.exe` 即可运行 |
| `edge-extension_<版本>.zip` | **浏览器扩展（可选）**：把网页一键收藏到collectorlite（见下文「浏览器扩展」） |
...
4. 点扩展图标把「collectorlite · 快速入库」固定到工具栏 → 右键图标 → **「选项」**；
...
> 注：应用产品名已于 2026-09 更名为 **collectorlite**；为兼容历史数据，
> 数据目录 identifier 保持不变，仍为 `com.local.bili-collector`：
